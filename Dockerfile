...
# docker build -t hazard_reporting_tool .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name hazard_reporting_tool hazard_reporting_tool
